...
def loadTable(database_path):
    ...
    image_name_list = [f'<img src="/assets/{i}" height="100">' if i is not None else None for i in image_name_list]
...
app.layout = html.Div([
    ...
    html.Div([
        html.P(children = ("Open Source Pflanzen-Datenbank"), className = "text-center"),
        html.A("Anleitung 📃", href="/assets/Anleitung_PlantDB.pdf", target="_blank", className = "text-right")
    ], className = "column"),
    html.Div([
        html.P("", className = "text-center"),
        html.P("Created by Benno 2025", className = "text-right")
    ], className = "column")
    ]),
    #introduce tabs
...
def render_content(tab):
    ...
    if tab == "tab_table":
        ...
        return html.Div([
            html.Div([
                html.H1(children = "Datenübersicht und Filterung")
            ...
            html.Div([
                ...
                dash_table.DataTable( 
                    ...
                    style_header = {'fontWeight': 'bold', 'backgroundColor': 'rgb(124, 124, 124)','color': 'white', "textAlign": "center", "fontSize": "18px"},
                    ...
                    #    "textAlign": "center"
                    #}],
                    style_cell = {"minHeight": "30px", "height": "auto", "lineHeight": "15px", "textAlign": "center", 'verticalAlign': 'middle'},
    ...
    #tab 2
        ...
        return html.Div([
            ...
            #row deletion GUI
            #----------------
            html.H3("Pflanze kompostieren"),
            html.P("Bitte die Zeilennummer der Zeile eingeben, die gelöscht werden soll."),
